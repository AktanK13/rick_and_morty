...
mixin _$MainEntity {
  ...
  List<LocationEntity> get locationEntity => throw _privateConstructorUsedError;
...
abstract class $MainEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({Info info, List<LocationEntity> locationEntity});
    ...
    return _then(_value.copyWith(
      info: null == info
          ...
          : info // ignore: cast_nullable_to_non_nullable
              as Info,
      locationEntity: null == locationEntity
...
class _$MainEntityImpl implements _MainEntity {
  const _$MainEntityImpl(
      {required this.info, required final List<LocationEntity> locationEntity})
      : _locationEntity = locationEntity;

  @override
  final Info info;
  final List<LocationEntity> _locationEntity;
  @override
  List<LocationEntity> get locationEntity {
    if (_locationEntity is EqualUnmodifiableListView) return _locationEntity;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_locationEntity);
  }

  @override
  String toString() {
    return 'MainEntity(info: $info, locationEntity: $locationEntity)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._locationEntity, _locationEntity));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, info, const DeepCollectionEquality().hash(_locationEntity));
...
abstract class _MainEntity implements MainEntity {
  const factory _MainEntity(
      ...
      required final List<LocationEntity> locationEntity}) = _$MainEntityImpl;
